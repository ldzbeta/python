...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv',mode="a", newline='', encoding='utf-8') as csv_file:
            new_data = [form.cafe.data, form.location.data, form.opening_time.data, form.closing_time.data, form.rating.data, form.wifi_strength.data, form.power_socket.data]
            csv_file.write('\n')
